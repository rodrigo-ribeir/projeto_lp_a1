...
'''
df_final[['Ciclo 1', 'Ciclo 2', 'Ciclo 3']].applymap(lambda x: np.cbrt(x))
...
df_final.plot.line(x = 'Dias após halving', y = ['Ciclo 1', 'Ciclo 2', 'Ciclo 3'])
#plt.savefig("meuplot.png", dpi=300)
plt.show()
